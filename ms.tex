...
\begin{figure*}[!t]
	...
	\begin{tikzpicture}[scale=1.1]
		...
		\node[canvas is zy plane at x=0, scale=1.1] at (-0.735, 1.235){\includegraphics[scale=0.491]{images/mri_image.png}};
		\node[canvas is zy plane at x=0, scale=1.1] at (0.93, 1.07){\includegraphics[scale=0.89]{images/layer_0_feature_map_0.png}};
		\node[canvas is zy plane at x=0, scale=1.1, opacity=0.5] at (0.83, 1.07){\includegraphics[scale=0.89]{images/layer_0_feature_map_2.png}};
		\node[canvas is zy plane at x=0, scale=1.1] at (2.63, 0.93){\includegraphics[scale=1.52]{images/layer_1_feature_map_0.png}};
		\node[canvas is zy plane at x=0, scale=1.1, opacity=0.5] at (2.42, 0.93){\includegraphics[scale=1.52]{images/layer_1_feature_map_1.png}};
		\node[canvas is zy plane at x=0, scale=1.1] at (4.42, 0.78){\includegraphics[scale=2.53]{images/layer_2_feature_map_0.png}};
		\node[canvas is zy plane at x=0, scale=1.1, opacity=0.5] at (4.03, 0.78){\includegraphics[scale=2.53]{images/layer_2_feature_map_3.png}};
		\node[canvas is zy plane at x=0, scale=1.1] at (6.42, 0.611){\includegraphics[scale=4.05]{images/layer_3_feature_map_0.png}};
		\node[canvas is zy plane at x=0, scale=1.1, opacity=0.5] at (5.6, 0.611){\includegraphics[scale=4.05]{images/layer_3_feature_map_2.png}};
		\node[canvas is zy plane at x=0, scale=1.1] at (8.815, 0.472){\includegraphics[scale=6.05]{images/layer_4_feature_map_0.png}};
		\node[canvas is zy plane at x=0, scale=1.1, opacity=0.5] at (7.22, 0.472){\includegraphics[scale=6.05]{images/layer_4_feature_map_1.png}};
		\node at (8, 0.472) {$\dots$};
		\node at (6, 0.472) {$\dots$};
		\node[canvas is zy plane at x=0] at (-1, -3){\includegraphics[scale=10]{images/layer_4_filter_0.png}};
		\node at (-0.8, -3) {$\dots$};
		\node[canvas is zy plane at x=0] at (-0.6, -3){\includegraphics[scale=10]{images/layer_4_filter_1.png}};
		\node[canvas is zy plane at x=0] at (0.8, -3){\includegraphics[scale=10]{images/layer_9_filter_0.png}};
		\node at (1, -3) {$\dots$};
		\node[canvas is zy plane at x=0] at (1.3, -3){\includegraphics[scale=10]{images/layer_9_filter_1.png}};
		\node[canvas is zy plane at x=0] at (2.5, -3){\includegraphics[scale=10]{images/layer_16_filter_0.png}};
		\node at (2.7, -3) {$\dots$};
		\node[canvas is zy plane at x=0] at (2.9, -3){\includegraphics[scale=10]{images/layer_16_filter_1.png}};
		\node[canvas is zy plane at x=0] at (4.2, -3){\includegraphics[scale=10]{images/layer_23_filter_0.png}};
		\node at (4.4, -3) {$\dots$};
		\node[canvas is zy plane at x=0] at (4.6, -3){\includegraphics[scale=10]{images/layer_23_filter_1.png}};
		\node[canvas is zy plane at x=0] at (6.3, -3){\includegraphics[scale=10]{images/layer_30_filter_0.png}};
		\node at (6.5, -3) {$\dots$};
		\node[canvas is zy plane at x=0] at (6.7, -3){\includegraphics[scale=10]{images/layer_30_filter_1.png}};
		\draw[<-] (-0.3, -3) -- (0.3, -3);
		\draw[<-] (1.6, -3) -- (2.1, -3);
		\draw[<-] (3.2, -3) -- (3.9, -3);
		\draw[<-] (4.8, -3) -- (5.9, -3);
